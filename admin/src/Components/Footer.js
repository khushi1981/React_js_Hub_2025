...
function Footer() {
  ...
  // ✅ Handle Client Login Button (open client side)
  const handleClientLogin = () => {
    window.open("http://localhost:5173", "_blank"); // Opens client app in new tab
  };
  ...
  return (
    ...
    >
      ...
      <Box sx={{ textAlign: "center", mb: 3 }}>
        <Typography
          ...
          sx={{
            ...
            backgroundClip: "text", // ✅ for cross-browser
            color: "transparent",
          }}
        >
          Knowledge Nexus
      ...
      >
        ...
        <Box>
          {["Home", "About Us", "Explore", "Subjects", "AuthPage"].map(
            (text, idx) => (
              <Link
                key={idx}
          ...
          {/* ✅ Client Login Button for Admin Side */}
          <Button
            variant="outlined"
